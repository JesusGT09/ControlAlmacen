package com.example.controlalmacen.ui.gallery
...
import com.example.controlalmacen.adapter.ProductoAdapter
...
class GalleryFragment : Fragment() {
   ...
   var Baseurl: String = GlobalInfo.BASE_URL
    ...
    private fun setupRecyclerView(listAnimation: List<Producto>) {
        val myadapter = ProductoAdapter(activity!!, listAnimation)
