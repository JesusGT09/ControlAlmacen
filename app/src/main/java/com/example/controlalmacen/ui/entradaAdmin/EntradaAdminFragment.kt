package com.example.controlalmacen.ui.entradaAdmin
...
import com.example.controlalmacen.ui.entradaAdmin.EntradaAdminFragment
...
import com.example.controlalmacen.adapter.EntradaAdminAdapter
...
class EntradaAdminFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_add -> {
                val intent = Intent(activity, AddEntradaAdminActivity::class.java)
                intent.putExtra("id", "")
    ...
    private fun setupRecyclerView(listAnimation: List<Entrada>) {
        val myadapter = EntradaAdminAdapter(activity!!, listAnimation)
