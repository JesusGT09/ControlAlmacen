...
import com.example.controlalmacen.adapter.ListadoProductoAdminAdapter
import androidx.recyclerview.widget.LinearLayoutManager
import java.lang.Exception
import java.util.ArrayList
import com.example.controlalmacen.GlobalInfo

class ListaProductoAdminActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView(
        ...
        val myadapter = ListadoProductoAdminAdapter(
            this,
            listAnimation,
            pid!!,
            pidproducto!!,
