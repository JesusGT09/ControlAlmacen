...
class EditarSalidaActivity : AppCompatActivity() {
    var bid: String? = null
    ...
    private fun EditSalida(
        ...
        val strReq: StringRequest = object : StringRequest(
            ...
            Baseurl+"editarSalida.php", Response.Listener { response ->
                hideDialog()
                Toast.makeText(this@EditarSalidaActivity, "" + response, Toast.LENGTH_LONG).show()
            }, Response.ErrorListener { error ->
                hideDialog()
                Toast.makeText(
                    this@EditarSalidaActivity,
                    "Error: " + error.message,
                    Toast.LENGTH_LONG
                ).show()
            }) {
    ...
    override fun onBackPressed() {
        val intent = Intent(this@EditarSalidaActivity, PersoMainActivity::class.java)
