...
class AddEntradaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_producto!!.setOnClickListener {
            val intent = Intent(this@AddEntradaActivity, ListaProductoActivity::class.java)
        ...
        btn_tipo!!.setOnClickListener {
            val intent = Intent(this@AddEntradaActivity, ListaTipoActivity::class.java)
            intent.putExtra("id", user!!.text.toString())
            intent.putExtra("fecha", fecha!!.text.toString())
            intent.putExtra("idproducto", idproducto!!.text.toString())
            intent.putExtra("producto", producto!!.text.toString())
    ...
    override fun onBackPressed() {
        val intent = Intent(this@AddEntradaActivity, PersoMainActivity::class.java)
        startActivity(intent)
    }
    ...
    private fun SaveEntrada(
        ...
        val strReq: StringRequest = object : StringRequest(
            ...
            Baseurl+"registrarEntrada.php", Response.Listener { response ->
                ...
                idtipo!!.setText("")
                tipo!!.setText("")
                Toast.makeText(this@AddEntradaActivity, "" + response, Toast.LENGTH_LONG).show()
            }, Response.ErrorListener { error ->
                hideDialog()
                Toast.makeText(
                    this@AddEntradaActivity,
                    "Error: " + error.message,
                    Toast.LENGTH_LONG
                ).show()
            }) {
