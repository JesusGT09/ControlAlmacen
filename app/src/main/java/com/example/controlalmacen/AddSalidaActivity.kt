...
class AddSalidaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_producto!!.setOnClickListener {
            val intent = Intent(this@AddSalidaActivity, ListaProductoActivity::class.java)
        ...
        btn_tipo!!.setOnClickListener {
            val intent = Intent(this@AddSalidaActivity, ListaTipoActivity::class.java)
            intent.putExtra("id", user!!.getText().toString())
            intent.putExtra("fecha", fecha!!.text.toString())
            intent.putExtra("idproducto", "" + idproducto!!.text.toString())
            intent.putExtra("producto", producto!!.text.toString())
    ...
    private fun SaveSalida(
        ...
        val strReq: StringRequest = object : StringRequest(
            ...
            Baseurl+"registrarSalida.php", Response.Listener { response ->
                ...
                idtipo!!.setText("")
                tipo!!.setText("")
                Toast.makeText(this@AddSalidaActivity, "" + response, Toast.LENGTH_LONG).show()
            }, Response.ErrorListener { error ->
                hideDialog()
                Toast.makeText(this@AddSalidaActivity, "Error: " + error.message, Toast.LENGTH_LONG)
                    .show()
            }) {
    ...
    override fun onBackPressed() {
        val intent = Intent(this@AddSalidaActivity, PersoMainActivity::class.java)
        startActivity(intent)
    }
