...
class EditarEntradaAdminActivity : AppCompatActivity() {
    var bid: String? = null
    ...
    private fun EditEntrada(
        ...
        val strReq: StringRequest = object : StringRequest(
            ...
            Baseurl+"editarEntrada.php", Response.Listener { response ->
                ...
                Toast.makeText(this@EditarEntradaAdminActivity, "" + response, Toast.LENGTH_LONG)
                    .show()
            }, Response.ErrorListener { error ->
                hideDialog()
                Toast.makeText(
                    this@EditarEntradaAdminActivity,
                    "Error: " + error.message,
                    Toast.LENGTH_LONG
                ).show()
            }) {
    ...
    override fun onBackPressed() {
        val intent = Intent(this@EditarEntradaAdminActivity, AdMainActivity::class.java)
